...
class KoalaLogMethodVisitor extends AdviceAdapter {
    ...
    private static final String COST_ANNOTATION_DESC = "Lcom/example/koala/KoalaLog;";
    ...
    protected void onMethodEnter() {
        if (isInjected) {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "com/example/koala/core/MethodCache", "request", "()I", false);
            ...
            for (int i = 0; i < argumentArrays.length; i++) {
                ...
                visitMethodInsn(INVOKESTATIC, "com/example/koala/core/MethodCache", "addMethodArgument",
    ...
    protected void onMethodExit(int opcode) {
        if (isInjected) {
            ...
            mv.visitVarInsn(ILOAD, methodId);
            mv.visitMethodInsn(INVOKESTATIC, "com/example/koala/core/MethodCache", "updateMethodInfo",
                    "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JI)V", false);

            mv.visitVarInsn(ILOAD, methodId);
            mv.visitMethodInsn(INVOKESTATIC, "com/example/koala/core/MethodCache",
